...
col_add2 =[
  [sg.InputText(key='-NUMBER1_ADD-', enable_events=True, size=(5, 1)),sg.Text('挿入する１つ前の文字番目を指定')],
...
col_replace2 = [
  [sg.InputText(key='-NUMBER1_REPLACE-', enable_events=True, size=(5, 1)),sg.Text('編集する最初の文字の文字番目を指定')],
  [sg.InputText(key='-NUMBER2_REPLACE-', enable_events=True, size=(5, 1)),sg.Text('開始位置から編集したい文字数を指定')],
...
col_del2 = [
  [sg.InputText(key='-NUMBER1_DEL-', enable_events=True, size=(5, 1)),sg.Text('削除する最初の文字の文字番目を指定')],
  [sg.InputText(key='-NUMBER2_DEL-', enable_events=True, size=(5, 1)),sg.Text('開始位置から削除する文字数を指定')],
]
# -------------------------------------------
# タブの定義
# -------------------------------------------
...
def main():
  ...
  # ウィンドウ定義　画面サイズ変更可
  window = sg.Window('ファイル名一括変更ツール', layout, resizable=True)
